...
//     mapJuzDanSurat.forEach(function(a,b,c){
//         // console.log(a.juz);
//         document.getElementById('juz').innerHTML += ${b+1}. ${a.juz} <br>;
//         document.getElementById('surat').innerHTML += ${b+1}. ${a.surat} <br>;

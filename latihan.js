...
let jadwalKegiatansholat = (prompt ("masukanjadwalkegiatanpondoksholat"));
let jadwalsholat =["shubuh","dzuhur","ashar","maghrib","isya"]
switch (masukanjadwalkegiatanpondoksholat) {
  case value:
...
let penjualan = [10,20,30,40,50,60,70]
